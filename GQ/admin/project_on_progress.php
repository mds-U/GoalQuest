<?php
    ...
    $page_title = "On-Progress Projects || Goal Quest";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">On-Progress Projects</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">On-Progress Projects</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div id="list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            ...
                            <table class="table table-hover table-condensed" id="myTable">
                                ...
                                <tbody>
                                    <?php
                                        $query = "SELECT * FROM project_list WHERE status = '1' AND user_id = {$_SESSION["user_id"]}";
